  ...
  template: `
    ...
    >
      <div class="flex items-center gap-4">
        <button
          type="button"
          (click)="emitFavoriteClicked()"
          [attr.aria-label]="'Favorite ' + product().name"
          [attr.aria-pressed]="product().isFavorite"
          class="min-h-10 rounded-lg border border-stone-900/15 bg-white font-black text-stone-900 hover:border-emerald-700/45 hover:bg-emerald-50 p-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-5">
...
export class DailyFoodRowComponent {
  ...
  readonly favoriteClicked = output<void>();

  protected emitFavoriteClicked() {
