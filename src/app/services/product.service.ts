...
const PRODUCTS: ReadonlyArray<Product> = Object.freeze([
  ...
  {
    id: 'nduranz-energy-unit-drink-90',
    brand: 'Nduranz',
    name: 'Energy Unit Drink 90',
    type: 'race',
    kind: 'drink',
    serving: '1 sachet in 500 ml, 83 g',
    servingGrams: 83,
    sourceLabel: 'Nduranz',
    sourceUrl: 'https://nduranz.com/products/nrgy-drink-90',
    nutritionPerServing: {
      ...EMPTY_NUTRITION,
      calories: 369,
      carbs: 93.8,
  ...
  {
    id: 'iso-isotonic-short-duration-rasbery',
    brand: 'Decathlon',
    name: 'Isotonic Short Duration Rasbery',
    type: 'race',
    kind: 'drink',
    serving: '1 sachet in 500 ml, 83 g',
    servingGrams: 83,
    sourceLabel: 'Decathlon',
    sourceUrl: 'https://abonnement.decathlon.fr/boisson-isotonique-iso-framboise-2kg',
    nutritionPerServing: {
      ...EMPTY_NUTRITION,
      calories: 364,
      carbs: 92,
